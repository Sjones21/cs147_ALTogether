...
export default class NewPostCaption extends Component {
  ...
  handleCustomAltText(customStr) {
    this.state.selectedImage.altText = customStr;
    return customStr;
  }
    ...
    return (
      <View style={[styles.container, {backgroundColor: 'white'}]}>
        <View style={{ justifyContent: 'center', margin: 1}}>
              ...
              <Text style={styles.captionAltText}>Alt text: {(this.state.altTextType == 'guided' || this.state.selectedImage.custom == null) ?
              this.parseAltText(this.state.selectedImage.autogenerated) :
              this.handleCustomAltText(this.state.selectedImage.custom)}</Text>
            </View>
